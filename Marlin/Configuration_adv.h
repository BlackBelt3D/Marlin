 ...
 */
   ...
   */
  #define WATCH_BED_TEMP_PERIOD 3600              // Seconds
...
#define MICROSTEP_MODES {16,16,8,16,16} // [1,2,4,8,16]
...
#define DIGIPOT_MOTOR_CURRENT { 170,140,200,200,140 }   // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
