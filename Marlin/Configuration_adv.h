...
#define HOMING_BUMP_MM      { 5, 0, 0 }       // (mm) Backoff from endstops after first bump
...
#define MICROSTEP_MODES { 16, 16, 8, 16, 16, 16 } // [1,2,4,8,16]
...
#define DIGIPOT_MOTOR_CURRENT { 170,140,170,170,140 }   // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
